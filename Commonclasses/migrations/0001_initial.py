    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category19', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='category19_common_lecture', to='Majors.category')),
                ('category20', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='category20_common_lecture', to='Majors.category')),
